...
<div class="col-md-6">
    <div class="form-group <?php echo form_error('codigo') == true ? 'has-error' : '' ?>">
        <label for="codigo">Codigo Tesis</label>
    ...
    <div class="form-group">
        ...
        <?php if (isset($libro->isbn_libro)): ?>
            <input type="text" class="form-control" id="isbn" name="isbn" placeholder="Matricula" value="<?php echo $libro->isbn_libro; ?>">
        <?php else: ?>
            <input type="text" class="form-control" id="isbn" name="isbn" placeholder="Matricula" >
        <?php endif;?>
...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <?php if (isset($libro->idioma_libro)): ?>
            <input type="text" class="form-control" id="idioma" name="idioma" placeholder="Tipo" value="<?php echo $libro->idioma_libro; ?>">
        <?php else: ?>
            <input type="text" class="form-control" id="idioma" name="idioma" placeholder="Tipo">
        <?php endif;?>
    </div>
