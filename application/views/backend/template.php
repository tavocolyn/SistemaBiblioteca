...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url(); ?>backend/dashboard"><i class="fa fa-dashboard"></i> INICIO PRINCIPAL</a></li>
	...
	<footer class="main-footer">
		...
		<strong>Copyright &copy; 2022-2024<a href="https://www.facebook.com/TessfpMomos/"> BugSolution </a>.</strong> All rights
		reserved.
	</footer>
