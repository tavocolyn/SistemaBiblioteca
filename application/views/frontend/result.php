...
<body>
    <div class="content">
        <div class="header">
            ...
            <h1>TESSFP INFORMATICA TRABAJOS TITULACION  <i> <a href="http://localhost/sistemabiblioteca/cpanel">
            <button class="btn btn-secondary" type="submit">Ingresar al Sistema</button>
            </a></i>  </h1>
        ...
        <div class="container content-search">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>Mediante los cuadros de texto puede buscar cualquier trabajo</p>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="form-group">
                        <div class="col-md-2">
                            <select name="campo" class="form-control">
                                ...
                                <option value="3" <?php echo $this->session->flashdata('campo') && $this->session->flashdata('campo') == 3 ? 'selected' : ''; ?>>Año</option>
                                <option value="4" <?php echo $this->session->flashdata('campo') && $this->session->flashdata('campo') == 4 ? 'selected' : ''; ?>>Modalidad</option>


                            </select>
                        </div>
                        <div class="col-md-3">
                            <input type="text" name="codtitulo" class="form-control" value="<?php echo $this->session->flashdata("codtitulo") == true ? $this->session->flashdata("codtitulo") : '' ?>" placeholder="Introduzca algun nombre, Codigo, año o modalidad">
                        </div>
                        <div class="col-md-3">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($libros as $libro): ?>
                                <tr>
                                    ...
                                    <?php $disponibles = $libro->publicacion_libro - $libro->prestados_libro;?>
                                    ...
                                    <td><?php echo $libro->idioma_libro; ?></td>
